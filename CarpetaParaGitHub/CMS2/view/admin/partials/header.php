...
<nav>
    <div class="nav-wrapper">
        ...
        <a href="<?php echo $_SESSION['home'] ?>admin" class="brand-logo" title="Inicio">
            <img src="<?php echo $_SESSION['public'] ?>img/logo.png" alt="Logo Lec">
        </a>
        ...
        <?php if (isset($_SESSION['usuario'])){ ?>
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                ...
                <?php if ($_SESSION['partidos'] == 1){ ?>
                    <li>
                        <a href="<?php echo $_SESSION['home'] ?>admin/partidos" title="Partidos">Partidos</a>
                    </li>
                <?php } ?>
