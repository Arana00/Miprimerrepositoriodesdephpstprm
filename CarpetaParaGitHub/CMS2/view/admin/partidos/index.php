<h3>
    <a href="<?php echo $_SESSION['home'] ?>admin" title="Inicio">Inicio</a> <span>| Partidos</span>
</h3>
<div class="row">
    <!--Nuevo-->
        ...
        <div class="card horizontal admin">
            <div class="card-stacked">
                ...
                <div class="card-action">
                    <a href="<?php echo $_SESSION['home']."admin/partidos/crear" ?>" title="Añadir nuevo partido">
        ...
        <article class="col s12 l6">
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    ...
                    <div class="card-action">
                        <a href="<?php echo $_SESSION['home']."admin/partidos/editar/".$row->id ?>" title="Editar">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/partidos/activar/".$row->id ?>" title="<?php echo $title ?>">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/partidos/home/".$row->id ?>" title="<?php echo $title ?>">
                ...
                <div class="card-reveal">
                    <span class="card-title grey-text text-darken-4">Borrar partido<i class="material-icons right">close</i></span>
                    <p>
                        ¿Está seguro de que quiere borrar el partido<strong><?php echo $row->titulo ?></strong>?<br>
                        Esta acción no se puede deshacer.
                    </p>
                    <a href="<?php echo $_SESSION['home']."admin/partidos/borrar/".$row->id ?>" title="Borrar">
