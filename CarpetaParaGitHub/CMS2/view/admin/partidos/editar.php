<h3>
    ...
    <a href="<?php echo $_SESSION['home'] ?>admin/partidos" title="Partidos">Partidos</a> <span>| </span>
    <?php if ($datos->id){ ?>
...
<div class="row">
    ...
    <form class="col s12" method="POST" enctype="multipart/form-data" action="<?php echo $_SESSION['home'] ?>admin/partidos/editar/<?php echo $id ?>">
        ...
        <div class="row">
            <div class="input-field col s12">
                <a href="<?php echo $_SESSION['home'] ?>admin/partidos" title="Volver">
