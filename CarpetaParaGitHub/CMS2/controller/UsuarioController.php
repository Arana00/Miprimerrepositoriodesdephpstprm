...
class UsuarioController
{
        ...
        //Si ha pulsado el botón de acceder, tramito el formulario
            ...
            if ($usuario){
                ...
                if (password_verify($campo_clave,$usuario->clave)) {
                    ...
                    $_SESSION["partidos"] = $usuario->partidos;
    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            $partidos = (filter_input(INPUT_POST, 'partidos', FILTER_SANITIZE_STRING) == 'on') ? 1 : 0;
            ...
            if ($id == "nuevo"){
                ...
                $this->db->exec("INSERT INTO usuarios (usuario, clave, partidos, usuarios) VALUES ('$usuario','$clave_encriptada',$partidos,$usuarios)");
                ...
                ($cambiar_clave) ?
                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',clave='$clave_encriptada',partidos=$partidos,usuarios=$usuarios WHERE id='$id'") :
                    $this->db->exec("UPDATE usuarios SET usuario='$usuario',partidos=$partidos,usuarios=$usuarios WHERE id='$id'");
