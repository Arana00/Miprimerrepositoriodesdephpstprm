 ...
 */
$_SESSION['public'] = '/CarpetaParaGitHub/CMS/public/';
...
function controlador($nombre=null){
    ...
    switch($nombre){
        ...
        case "noticias": return new NoticiaController; //back-end
        case "usuarios": return new UsuarioController; // autenticación y back-end de usuarios
    }
